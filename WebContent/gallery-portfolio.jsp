...
<body>
              ...
              <ul id="jetmenu" class="jetmenu blue">
                ...
                <li class="active"><a href="#">Portfolio</a>
                  <ul class="dropdown">
                    ...
                    <li><a href="single-portfolio-2.jsp.html">Single Portfolio 2</a></li>
                    <li><a href="portfolio-2.html">Portfolio (2 Columns)</a></li>
                    <li><a href="portfolio-3.html">Portfolio (3 Columns)</a></li>
                    <li><a href="gallery-portfolio.jsp">Gallery</a></li>
  ...
  <section class="section1">
    ...
    <div style="clear:both;display: block">
          <ul style="list-style:none;float:left;display: block;margin:0 auto">
            <li style="float:left;margin-left:10px"><a href="SelectAllBankServlet?current=1" class="dmbutton2" >所有题库${num }</a></li>
            <li style="float:left;margin-left:10px"><a href="SelectBankOfJavaEEServlet" class="dmbutton2" >JavaEE题库</a></li>
            <li style="float:left;margin-left:10px"><a href="SelectBankOfJspServlet" class="dmbutton2" >JSP题库</a></li>
            <li style="float:left;margin-left:10px"><a href="SelectBankOfOracleServlet" class="dmbutton2" >Oracle题库</a></li>
            <li style="float:left;margin-left:10px"><a href="SelectBankOfOracleServlet" class="dmbutton2" >HTML题库</a></li>
            <li style="float:left;margin-left:10px"><a href="SelectBankOfOracleServlet" class="dmbutton2" >JS题库</a></li>
            <li style="float:left;margin-left:10px"><a href="SelectBankOfOracleServlet" class="dmbutton2" >JDBC题库</a></li>
            <li style="float:left;margin-left:10px"><a href="SelectBankOfOracleServlet" class="dmbutton2" >JQ题库</a></li>
            <li style="float:left;margin-left:10px"><a href="SelectBankOfOracleServlet" class="dmbutton2" >JQ题库</a></li>
            <li style="float:left;margin-left:10px"><a href="SelectBankOfOracleServlet" class="dmbutton2" >JQ题库</a></li>
            <li style="float:left;margin-left:10px"><a href="SelectBankOfOracleServlet" class="dmbutton2" >JQ题库</a></li>
          </ul>
          ...
          <div class="recentitems portfolio">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mockups">
              <div class="he-wrap tpl6 market-item">
              	<input type="hidden" value="${xyz.bankid } name="bankid">
                <img src="${xyz.img }" alt="" >
                <div class="he-view">
                  ...
                  <!--  查看详细信息页之前，需要判断是否有用户登录，若没登陆，跳转到登录界面进行登录 ***************************************-->
                  <!--  查看详细信息页之前，需要判断是否有用户登录，若没登陆，跳转到登录界面进行登录 ***************************************-->
                  <!--  查看详细信息页之前，需要判断是否有用户登录，若没登陆，跳转到登录界面进行登录 ***************************************-->
                  
                    <a href="SelectlBankInfoServlet?bankid=${xyz.bankid }" class="dmbutton a2" data-animate="bounceInRight"><i class="fa fa-link"></i></a>
                    <div class="portfolio_category text-center a2" data-animate="fadeIn">
                      <a href="gallery-portfolio.jsp#" >${xyz.info }</a>
                    </div>
                    <!-- portfolio_category -->
                  </div>
                  <!-- he bg -->
  ...
  <!-- end section -->
	...
	<!-- 分页功能   -->
          <p    >
          	<span style="margin-left:800px;">一共${requestScope.sum }页 &nbsp;&nbsp;&nbsp;&nbsp;</span>
            <a  href="SelectAllBankServlet?current=1">首页</a>
			<a href="SelectAllBankServlet?current=${current-1 }">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="SelectAllBankServlet?current=${current+1 }">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="SelectAllBankServlet?current=${requestScope.sum }">尾页</a>&nbsp;&nbsp;&nbsp;&nbsp;
          </p>
          ${msg }
	<!-- 分页功能   -->
